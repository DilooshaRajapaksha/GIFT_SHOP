    ...
    <header className="topbar">
      <div className="bar">
        ...
        <form className="search" role="search" onSubmit={e => e.preventDefault()}>
          ...
          <input placeholder="Search Gift Boxes..." />
        </form>

        <div className="icons">
          <button className="icon-btn" aria-label="Cart">
            <svg viewBox="0 0 24 24"><path d="M7 18a2 2 0 11-.001 3.999A2 2 0 017 18zm10 0a2 2 0 11-.001 3.999A2 2 0 0117 18zM6.2 6l.8 2h10.6l-1.4 7H8.4l-2.2-9H3V4h3.2z"/></svg>
          </button>
